      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <img src="/purriosity_logo.svg" alt="Purriosity" className="h-10 w-auto mb-4" />
            <p className="text-text-secondary text-sm mb-4">
              Die verrückteste Fundgrube für Katzenliebhaber. Kuratierte Produkte, die du nirgendwo
              anders findest.
            </p>
            {/* Newsletter */}
